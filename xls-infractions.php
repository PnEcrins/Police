...
$csv_output = "Id\tDate\tJour\tInfraction\tQualification\tType d'intervention\tAgents presents\tCommune\tSecteur\tStatut de la zone\tX (WGS84)\tY (WGS84)\tObservation\tNombre de contrevenants\tDate limite de prescription\tNumero de parquet\tSuite donnee\tCommentaire de suivi\tMontant de l'amende\tConstitution de partie civile\tDate de la constitution\tMontant des dommages et interets";
//Aller à la ligne
$csv_output .= "\n";

//Requete SQL
$query = "
SELECT interv.id_intervention, interv.date, to_char(date, 'Day') as jour, comm.commune, sect.secteur, stat.statutzone, typeint.type_intervention, inf.infraction, qualif.qualification, interv.observation, interv.coord_x, interv.coord_y, interv.nbcontrevenants, interv.suivi_date_limite, interv.suivi_num_parquet, interv.suivi_suite_donnee, interv.suivi_commentaire, interv.suivi_montant_amende, interv.suivi_partie_civile, interv.suivi_date_constitution, interv.suivi_montant_dommages
